...
const SECTIONS: { title: string; body: string }[] = [
  {
    ...
    body: "We collect the information you provide when creating your student account, such as your name, email address, and profile details. We also collect content you upload, including practice submissions and progress data."
  },
  {
    title: "2. How We Use Your Information",
    body: "Your information is used to operate and improve the app, match you with challenges and teachers, track your learning progress, communicate with you about your account, and provide customer support."
  },
  {
        ...
        <View style={{ paddingHorizontal: 20, paddingTop: insets.top + 12, paddingBottom: 32 }}>
          <View style={[styles.heroCard, localStyles.heroCard]}>
            ...
            <Text style={[styles.subheading, { marginBottom: 0 }]}>
              How we collect, use, and protect your data as a student on our platform.
            </Text>
          </View>
